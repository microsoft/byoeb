...
class User(BaseModel):
    ...
    user_region: Optional[str] = Field(None, description="Region of the user", example="US")
    ...
    experts: Optional[List[str]] = Field(default_factory=list, description="List of expert phone numbers associated with the user")
